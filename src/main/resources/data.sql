...
values (21, true, now(), 'GAS', 'EU-021', 'MANUFACTURER-X', 2.0, 1, null);
INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, MANUFACTURER, RATING, SEAT_COUNT, DRIVER_FK)
values (22, true, now(), 'GAS', 'EU-022', 'MANUFACTURER-X', 2.0, 2, 6);
INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, MANUFACTURER, RATING, SEAT_COUNT, DRIVER_FK)
values (23, true, now(), 'ELECTRIC', 'EU-023', 'MANUFACTURER-Y', 2.0, 3, null);